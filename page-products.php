	...
	<section class="container featured-products">
		...
		<div id="featured-list" class="owl-carousel featured-list">
			<?php foreach($products as $product) : ?>
				<div class="text-center"> <figure style="background-image: url(<?=thumbnail_src($product->ID)?>)"><a href="#"><img src="<?=asset('images/magnify.png')?>" alt="#"/></a></figure> <h3><?=$product->post_title?></h3> <article class="small"><?=get_the_excerpt($product->ID)?></article> </div>
			<?php endforeach; ?>
	</div>
